            ...
            <div class="inner-container">
                <div class="row clearfix">
                    ...
                    <div class="form-column col-lg-12 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="pattern-layer-four" style="background-image: url(images/icons/pattern-20.png)">
                            </div>
                            ...
                            <div class="contact-form">
                                <form method="post" action="/blog/{{ $post->id }}" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group">
                                        <button class="theme-btn btn-style-five" type="submit"><span
                                                class="txt">Edit Post</span></button>
                                    </div>
